...
import { FILE_UPLOAD_URL, GET_MY_LIKE_LIST_URL, GET_MY_LIST_URL, PATCH_PROFILE_URL, authorizationHeader, mutipartHeader } from "src/constants/api";
        ...
        <Box sx={{display: 'flex', justifyContent: 'center'}}>
            <Box width='500px' sx={{display: 'flex', flexDirection: 'column', mt:'50px'}}>
                <Box sx={{display:'flex', justifyContent:'space-between'}}>
                    ...
                    <IconButton onClick={() => navigator(`/board/post-board`)}>
                        <CreateIcon />
                    </IconButton>
                </Box>
